...
export class TasksService {
  ...
  initializeMockTasks(): void {
    const mockTasks: Task[] = [
      {
        id: '1',
        title: 'Complete Angular Signals tutorial',
        description: 'Learn how to use signals for state management',
        status: 'Pending',
      ...
      },
      {
        ...
        description: 'Implement CRUD operations using signals',
        status: 'Done',
      ...
      },
      {
        ...
        description: 'Review Angular Signals documentation',
        status: 'In Progress',
      ...
      },
      {
        ...
        description: 'Review and improve application performance metrics',
        status: 'In Progress',
